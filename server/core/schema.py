...
# class Query(AddressQuery, UserQuery, InventoryQuery, ProductQuery, graphene.ObjectType):
#     pass

# for address, inventory and product
class Query(AddressQuery, InventoryQuery, ProductQuery, graphene.ObjectType):
    pass


# class Mutation(AddressMutation, UserMutation, InventoryMutation, ProductMutation, graphene.ObjectType):
